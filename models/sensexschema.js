...
const SensexCompanySchema = new mongoose.Schema({
  companyName: {
    type: String,
    required: true,
    unique: true,
...
SensexCompanySchema.methods.calculateFluctuation = function () {
...
module.exports = mongoose.model('SensexCompany', SensexCompanySchema);
